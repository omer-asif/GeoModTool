...
static const char qt_meta_stringdata_GeoXGLWidget[] = {
    "GeoXGLWidget\0\0widgetContentChanged()\0"
    "pointSelected(int)\0"
};
...
const QMetaObjectExtraData GeoXGLWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GeoXGLWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_GeoXGLWidget,
      qt_meta_data_GeoXGLWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GeoXGLWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GeoXGLWidget))
