...
static const char qt_meta_stringdata_EnumerationElementEditor[] = {
    "EnumerationElementEditor\0\0i\0"
    "sltIndexChanged(int)\0"
};
...
const QMetaObjectExtraData EnumerationElementEditor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject EnumerationElementEditor::staticMetaObject = {
    { &ElementEditor::staticMetaObject, qt_meta_stringdata_EnumerationElementEditor,
      qt_meta_data_EnumerationElementEditor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &EnumerationElementEditor::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EnumerationElementEditor))
