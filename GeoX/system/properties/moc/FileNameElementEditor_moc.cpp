...
static const char qt_meta_stringdata_FileNameElementEditor[] = {
    "FileNameElementEditor\0\0text\0"
    "sltTextChanged(QString)\0sltReturnPressed()\0"
    "sltDotDotDotClicked()\0"
};
...
const QMetaObjectExtraData FileNameElementEditor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FileNameElementEditor::staticMetaObject = {
    { &ElementEditor::staticMetaObject, qt_meta_stringdata_FileNameElementEditor,
      qt_meta_data_FileNameElementEditor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FileNameElementEditor::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FileNameElementEditor))
