...
static const char qt_meta_stringdata_PopupWindow[] = {
    "PopupWindow\0"
};
...
const QMetaObjectExtraData PopupWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PopupWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PopupWindow,
      qt_meta_data_PopupWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PopupWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PopupWindow))
