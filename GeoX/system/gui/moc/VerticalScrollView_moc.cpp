...
static const char qt_meta_stringdata_VerticalScrollView[] = {
    "VerticalScrollView\0"
};
...
const QMetaObjectExtraData VerticalScrollView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VerticalScrollView::staticMetaObject = {
    { &QScrollArea::staticMetaObject, qt_meta_stringdata_VerticalScrollView,
      qt_meta_data_VerticalScrollView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VerticalScrollView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VerticalScrollView))
